...
public final class String
     ...
     * @since  1.5
     */
    public String(StringBuilder builder) {// 非线程安全
    ...
    */
     ...
     *          如果没有发生替换则返回this，否则返回new String(...)
     */
    public String replace(char oldChar, char newChar) {
        if (oldChar != newChar) {
            ...
            while (++i < len) {// 定位第一个需要替换的位置
                if (val[i] == oldChar) {
                    break;
                }
            }
            if (i < len) {// 从需要替换的位置开始比对替换
            	// 如果需要替换则赋值替换后的字符，如果不需要则使用原有字符
